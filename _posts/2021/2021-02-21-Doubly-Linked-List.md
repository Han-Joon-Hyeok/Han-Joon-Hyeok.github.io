...
![Doubly Linked Lists(1)](</assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list(1).jpg>)

일반적인 연결 리스트는 한 방향으로(head에서 tail로)만 진행된다면, 양방향 연결 리스트는 앞, 뒤로도 진행이 가능하다.

그래서 노드를 생성할 때, `prev`에 대한 정보를 함께 포함하게 된다.

![Doubly Linked Lists(2)](</assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list(2).jpg>)

그리고 dummy 노드를 리스트 처음과 끝에 모두 두어야 데이터를 담고 있는 노드들은 모두 같은 형태를 띄고, 다양한 기능을 구현하는데 있어 편리해진다는 장점이 생긴다.

![Doubly Linked Lists(3)](</assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list(3).jpg>)

![Doubly Linked Lists(4)](</assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list(4).jpg>)
...
![Doubly Linked Lists Traverse](/assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list-traverse.png)
...
![Doubly Linked Lists insertAfter](/assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list-insertAfter.png)
...
![Doubly Linked Lists popAfterBefore](/assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list-popAfterBefore.png)
...
![Doubly Linked Lists concat(1)](</assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list-concat(1).png>)

![Doubly Linked Lists concat(2)](</assets/images/2021/2021-02-21-Doubly-Linked-List/doubly-linked-list-concat(2).png>)
